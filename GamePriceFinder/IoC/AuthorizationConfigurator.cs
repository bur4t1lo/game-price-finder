...
namespace GamePriceFinder.IoC
{
    ...
    {
        public static void ConfigureServices(this IServiceCollection services, GamePriceFinderSettings settings)
        {
            ...
            services.AddIdentity<User, UserRoleEntity>(options =>
            {
                ...
                .AddEntityFrameworkStores<GamePriceFinderDbContext>()
